"""一次性脚本：对《错季锁星》第 54 章跑五维自评（对标），并沉淀写作改进规则。"""
...
CH54 = Path("works/错季锁星/chapters/第54章.md")
...
def main() -> int:
    ...
    chapter_text = CH54.read_text(encoding="utf-8")
    title = "错季锁星"
